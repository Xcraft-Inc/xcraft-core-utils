...
/**
 * Generate a reference number useful for human exchanges.
 *
 * It uses only upper cases without 0, O, 1, I which can be confused.
 *
 * @returns {String} A new reference.
 */
exports.genReference = () => {
